...
RS2_down_asns = {}
RS2_down_routes_txt = requests.get("http://[2a0a:280:f000:3::3]:3234/bird?q=show%20route%20where%20%28210979%2C65530%2C7%29%21~bgp_large_community%26%26source%3DRTS_BGP%20all").text
